...
bool Action::monitoredTakeoff(DJI::OSDK::Vehicle* vehiclePtr, int timeout)  //function like Dji************************************************************
{
    Action::Result takeoff_result = _impl->takeoff();
...
bool Action::monitoredLanding(DJI::OSDK::Vehicle* vehiclePtr, int timeout)   //function like Dji************************************************************
{
     Action::Result land_result = _impl->land();
