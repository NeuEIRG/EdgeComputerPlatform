...
public:
	...
	void accept(const std::string& localHost, int localPort)
	{
		...
		// bind socket to local address.
		socklen_t addrlen = sizeof(sockaddr_in);
		   std::cout<<"TcpClientPort.cpp 141"<<std::endl;
   ...
   std::cout<<"TcpClientPort.cpp 149"<<std::endl;
